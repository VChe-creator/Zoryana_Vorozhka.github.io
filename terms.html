...
<head>
    ...
    <title>Користувацька угода - Зоряна ворожка</title>
</head>
<body>
    ...
    <ul>
        <li><b>Телеграм-бот «Зоряна ворожка» (далі – «Платформа» або «Сервіс»)</b> – програмний інтерфейс у месенджері Telegram, який надає астрологічні прогнози, гадання на картах Таро та інші розважальні послуги. Послуги класифікуються як розважальні та не є професійними консультаціями.</li>
        <li><b>Правовласник</b> – фізична або юридична особа, яка володіє правами на бота (Адміністрація), зареєстрована відповідно до законодавства України.</li>
        <li><b>Користувач</b> – особа, яка взаємодіє з ботом через інтерфейс Telegram. Акцептом угоди вважається початок використання сервісу.</li>
        <li><b>Аккаунт</b> – обліковий запис Користувача в системі Telegram, через який здійснюється взаємодія з Сервісом.</li>
    </ul>
    ...
    <p>Користувач зобов’язується відшкодувати Адміністрації всі витрати, збитки, вимоги або претензії, що виникли внаслідок порушення умов цієї Угоди, неправомірного використання Платформи або дій, які завдали шкоди третім особам. Цей пункт поширюється на будь-які претензії, включаючи витрати на юридичне представництво.</p> <h3>6.4. Обов’язки Правовласника</h3> <ul> <li>Забезпечувати стабільну роботу бота;</li> <li>Надавати технічну підтримку через Telegram або електронну пошту;</li> <li>Дотримуватись умов конфіденційності.</li> </ul> <h3>6.5. Обов’язки Користувача</h3> <ul> <li>Не використовувати бота для розповсюдження незаконного контенту;</li> <li>Не намагатись отримати несанкціонований доступ до даних чи зламати алгоритми;</li> <li>Повідомляти про технічні збої.</li>
 </ul>
представництво.</p>
